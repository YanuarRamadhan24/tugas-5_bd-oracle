            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <a class='btn btn-success' href='add_pelanggan.php'><i class='fa fa-plus'></i> Tambah Data Pelanggan</a>
                </div>
                        ...
                        <td class="td-actions">
						  <a class='btn btn-success' href="edit_pelanggan.php?id_pelanggan=<?php echo $d["ID_PELANGGAN"];?>" 
							><i class='fa fa-edit'></i></a>
                              ...
                              <a class='btn btn-danger' onclick="return confirm('Anda yakin ingin menghapus data tersebut?');" href="aksi_pelanggan.php?act=delete&id_pelanggan=<?php echo $d["ID_PELANGGAN"];?>" 
